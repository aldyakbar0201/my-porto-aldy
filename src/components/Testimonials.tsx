...
const Testimonials: React.FC = () => {
  const testimonials = [
    {
      name: "John Doe",
      title: "Project Manager at TechCorp Solutions",
    ...
    },
    {
      ...
      image: "/michael-brown.jpg", // Replace with actual image path
      testimonial:
  ...
  return (
    <section className="bg-black text-white py-16">
      <div className="container mx-auto px-6 md:px-12 lg:px-20">
        <h2 className="text-3xl font-bold text-center text-green-500 mb-6">Testimonials</h2>
